...
export const puzzles: Puzzle[] = [
  ...
  },
  {
    ...
    conservationStatus: 'Critically Endangered',
    description: '九刺鱼需要收集繁茂水草来营造爱巢。然而，河底硬化、非法捕捞和罗非鱼等外来物种的疯狂啃咬，导致其濒临灭绝。请拖曳这几项核心生态威胁到下方的保护解密站中以激活气泡信码！',
    storyContext: '我们来到微型模拟鱼缸区，清澈的溪流中却充斥着人类留下的粗野痕迹和凶悍的外来入侵天敌。净化水生家园，才能协助九刺鱼进行繁育。',
    hints: [
      '在模拟湿地池中，仔细看！有废塑料、地笼网、侵略性十足的罗非鱼，以及人工硬化的硬水泥河床。',
      '请将水体内各种核心生态威胁物品拖入下方对应的保护解密站中以激活气泡信码。',
      '全部 4 项危害净化复苏后，九刺鱼吐出含金的生境氧气汽泡，自锁结成通关信码【N9】。'
    ],
    correctAnswer: 'N9'
  },
  {
    id: 5,
    type: 'curtain',
    title: '2.2 生存之战：掀开竹帘探秘心腹之患',
    subtitle: '实景翻帘观鱼之痛 - 寻找上海本土鱼类最大克星',
    speciesName: '外来入侵生物 (Invasive Killers)',
    scientificName: 'Gambusia affinis et al.',
    conservationStatus: 'Endangered',
    description: '引导观众寻找现场的一块物理实景遮光帘，亲手将其掀开！在这里，阴暗无光的隐秘角落隐藏着上海本土鱼类的头号公敌，也是最具破坏力、最霸道的外来特有入侵种。动手掀开它，见证生命多样性的最大生态伤痛。',
    storyContext: '在真实的展厅「生存之战」区隐藏着一个“生命暗角”，拉开帘子，暗中潜伏的水族公敌正在疯狂啃噬本土鱼群幼苗。拉开现实中的帘子，并在手机上进行确认，即可呼唤生命微光！',
    hints: [
      '请移步到现场「生存之战」展区的河道边，寻找挂有醒目文字提示、遮挡着隐秘水生生态或箱体的遮光黑帘/竹帘。',
      '用手轻轻推开或拉起这块物理帘子，确认隐秘空间里展出的头号外来威胁是什么。',
      '亲手拉开物理帘子后，在下方点击“我已经打开了”按钮，即可激活本关！'
    ],
    correctAnswer: '我已经打开了'
  },
  {
    id: 6,
    type: 'map',
    ...
    conservationStatus: 'Endangered',
    description: '胭脂鱼被称为“一帆风顺”。由于大坝并人为排污，其长江口迁徙航路一度受切断。我们要引导放流追踪小队带着珍贵的胭脂鱼幼苗，绕过上海百年街区弄堂内复杂的管线、施工堵塞点，顺利把鱼运送到地标点「康平路105号」实景净水监测台。',
    storyContext: '上海阡陌纵横 of 弄堂在古水系中正是各级小支流的演化。我们将一桶精心培育的本土胭脂鱼苗作为“生态纽带”，运往宛平弄堂微型生物廊道。',
    hints: [
